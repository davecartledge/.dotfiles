# Generated by Powerlevel10k configuration wizard on 2020-05-31 at 20:56 BST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 11985.
# Wizard options: awesome-patched + powerline, large icons, classic, light,
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR='%000F\uE0B1'
  # Separator between same-color segments on the right.
  typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR='%000F\uE0B3'
  ...
  typeset -g POWERLEVEL9K_DIR_MAX_LENGTH=8
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%008F'  # grey foreground
      local      clean='%002F'  # green foreground
      local   modified='%003F'  # yellow foreground
      local  untracked='%009F'  # pink foreground
      local conflicted='%001F'  # red foreground
    else
      # Styling for incomplete and stale Git status.
      local       meta='%008F'  # grey foreground
      local      clean='%008F'  # grey foreground
      local   modified='%008F'  # grey foreground
      local  untracked='%008F'  # grey foreground
      local conflicted='%008F'  # grey foreground
    fi
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=008
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=008
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND=008
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=014
